...
{   
    for(auto iter = usedPtrList.begin();iter != usedPtrList.end();iter++)
    {
        resetGrid(*iter);
    }
    usedPtrList.clear();
...
{   
    ...
    usedPtrList.push_back(startPtr);
            ...
            */
            ...
            if(neighborPtr -> id == 0){ //discover a new node, which is not in the closed set and open set
                ...
                */
                ...
                neighborPtr->fScore = neighborPtr->gScore + 2*getHeu(neighborPtr,endPtr);//启发式
